          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2><i class="fas fa-hourglass-end"></i> Usss</h2>
                <h3 class="font-weight-light">Sesión caducada!</h3>
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-12 text-center mt-xl-2">
                <a class="text-white font-weight-medium" href="{{ route('login') }}">Volver a iniciar</a>
              </div>
            </div>
            <div class="row mt-5">
