...
class Order extends Model
{
    ...
    public function add_order_details($shopping_cart){
        foreach ($shopping_cart->shopping_cart_details as $key => $abc) {
            ...
            $results[] = array("quantity"=>$shopping_cart->shopping_cart_details[$key]->quantity, "price"=>$abc->product->sell_price,"product_id"=>$shopping_cart->shopping_cart_details[$key]->product_id);
        }
