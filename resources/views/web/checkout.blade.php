...
@section('title', $business->name . ' | Checkout')
@section('styles')
                               ...
                               <div class="order-payment-method">
                                  {{--    <div class="single-payment-method show">
                                        ...
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="checkpayment" name="paymentmethod"
                                                    value="check" class="custom-control-input" />
                                    ...
                                    <div class="single-payment-method">
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="{{$paymentPlatform->name}}payment" name="payment_platform"
                                                    value="{{$paymentPlatform->id}}" class="custom-control-input" required/>
                                                <label class="custom-control-label" for="{{$paymentPlatform->name}}payment">{{$paymentPlatform->name}} <img
                                                        src="galio/assets/img/paypal-card.jpg"
                                                        class="img-fluid paypal-card" alt="{{$paymentPlatform->name}}" /></label>
                                            </div>
                                        </div>
