                                ...
                                <tbody>
                                    @foreach ($posts as $post)
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_black" href="">{{ $post->title }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if (isset($post->published_at))
                                                    {{ \Carbon\Carbon::parse($post->published_at)->isoFormat('D [de] MMMM [de] YYYY [a las] h:mm A') }}
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td style="width: 20%;">
                                                <form method="POST" action="{{ route('posts.destroy', $post) }}"
                                                    ...
                                                    <button class="btn btn-outline-danger delete-confirm" type="button"
                                                        onclick="confirmDelete('delete-item_{{ $post->id }}')"
                                                        title="Eliminar">
