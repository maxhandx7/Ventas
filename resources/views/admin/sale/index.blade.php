                        ...
                        <table id="order-listing" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="badge badge-success" href="{{ route('change.status.sales', $sale)}}" title="Esta pago">
                                    ...
                                    @else
                                    <td>
                                        <a class="badge badge-danger" href="{{ route('change.status.sales', $sale)}}" title="no pago">
                                            No pago
                                        </a>
