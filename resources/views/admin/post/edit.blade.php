            ...
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        @enderror
                        "
                                name="excerpt" id="excerpt" rows="3" required>{{ old('excerpt', $post->excerpt) }}</textarea>
                            @error('excerpt')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        @enderror
                        "
                                name="body" id="body" rows="10" required>{{ old('body', $post->body) }}</textarea>
                            @error('body')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="card-body">
                        ...
                        "
                                ...
                                <option value="PUBLIC" {{ old('status', $post->status) == 'PUBLIC' ? 'selected' : '' }}>
                                    Publico</option>
                                <option value="HIDDEN" {{ old('status', $post->status) == 'HIDDEN' ? 'selected' : '' }}>
                                    Oculto</option>
                                <option value="PROGRAM" {{ old('status', $post->status) == 'PROGRAM' ? 'selected' : '' }}>
                                    Programar</option>
                            </select>
                            @error('status')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group" id="date_published_at">
                            ...
                            <div class="input-group date datepicker">
                                <input type="text" id="datetimepicker-popup" name="published_at"
                                    class="form-control
                            @error('published_at') 
                                is-invalid 
                            @enderror
                        ...
                        @if ($post->iframe)
                            <div class="form-group">
                                <label for="iframe">Vista previa</label>
                                <div class="jumbotron" style="max-width: 100%; overflow: auto;">
