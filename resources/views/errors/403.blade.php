          ...
          <div class="col-lg-7 mx-auto text-white">
            ...
            <div class="row mt-5">
              <div class="col-12 mt-xl-2">
                <span class="float-none float-sm-center d-block mt-1 mt-sm-0 text-center"><i class="fa fa-code text-dark"></i>&nbsp;<b><a style="text-decoration: none; color:rgb(17, 15, 129);" href="https://afdeveloper.com/" target="_blank">&nbsp;AF</a> </b> </span>
              </div>
            </div>
          </div>
        </div>
